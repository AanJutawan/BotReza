...
helpMessage ="""=====[Y̶̷̲̅O̶̷̲̅V̶̷̲̅A̶̷̲̅N̶̷̲̅B̶̷̲̅O̶̷̲̅T̶̷̲̅]=====
...
#-----------------------------------------------
    ...
    #-------------------------------------------------#
        ...
        #-------------Fungsi Spam Start---------------------#
                ...
                ki7.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
                ki8.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
                ki9.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
                ki10.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
        #-------------Fungsi Spam Finish---------------------#
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
                ...
                ki3.sendText(msg.to,"Tukang BOONG On")
                ki4.sendText(msg.to,"Tukang Kodel On")
                ki5.sendText(msg.to,"Tukang Cabul On")
                ki6.sendText(msg.to,"Tukang Berak On")
                ki7.sendText(msg.to,"Tukang Jamu on")
                ki8.sendText(msg.to,"Tukang Bakso On")
                ki9.sendText(msg.to,"Tukang Bakmi On")
                ki10.sendText(msg.to,"Tukang Tidur On")
    ...
    for zx in range(0,20):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          ki7.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Aku Juga Ikutin Boss Aku Like Status Kamu Ka\n\n Like Back yah Ka 😊")
          ki8.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          ki8.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Aku Juga Ikutin Boss Aku Like Status Kamu Ka\n\n Like Back yah Ka 😊")
          ki9.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          ki9.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Aku Juga Ikutin Boss Aku Like Status Kamu Ka\n\n Like Back yah Ka 😊")
          ki10.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          ki10.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Aku Juga Ikutin Boss Aku Like Status Kamu Ka\n\n Like Back yah Ka 😊")
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto like by ^Yovan Bot^\nStatus Boss udah Kami Like\nOwner Kami :\nYovan Destroyers")
                    print "Like"
                except:
                    pass
            else:
